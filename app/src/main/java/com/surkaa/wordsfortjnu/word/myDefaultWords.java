...
public class myDefaultWords {
    static final int notRequired = 1;
    Context context;
    ...
    public void userSelectImport(boolean isCET4) {
        ...
        builder.setPositiveButton("我不需要!", (dialog, which) -> insertDefaultWord(isCET4, notRequired));
        builder.setNegativeButton("不, 我得留着", (dialog, which) -> insertDefaultWord(isCET4, Integer.MAX_VALUE));
        builder.create().show();
    }

    public void insertDefaultWord(boolean isCET4, int maxNumber) {
        try {
            if (isCET4) {
                insertDefaultWordsCET4(maxNumber);
            } else {
                insertDefaultWordsCET6(maxNumber);
            }
        } catch (IOException e) {
            showError();
        }
    ...
    public void insertDefaultWordsCET4(int maxNumber) throws IOException {
    ...
    public void insertDefaultWordsCET6(int maxNumber) throws IOException {
